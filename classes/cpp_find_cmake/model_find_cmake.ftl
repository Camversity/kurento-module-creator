...
if (NOT "@_SERVER_GENERATED_HEADERS@" STREQUAL "")
  if (TARGET ${name_lower}impl)
    set (${name}_IMPLEMENTATION_GENERATED_INCLUDE_DIR "@_PARAM_SERVER_STUB_DESTINATION@")
  else ()
...
if (NOT "@_PARAM_SERVER_IMPL_LIB_EXTRA_HEADERS@" STREQUAL "")
  if (TARGET ${name_lower}impl)
    set (${name}_IMPLEMENTATION_EXTRA_INCLUDE_DIR "@_PARAM_SERVER_IMPL_LIB_EXTRA_HEADERS_PREFIX@")
  else ()
...
if (NOT "@_PARAM_INTERFACE_LIB_EXTRA_HEADERS@" STREQUAL "")
  if (TARGET ${name_lower}interface)
    set (${name}_INTERFACE_EXTRA_INCLUDE_DIR "@_PARAM_INTERFACE_LIB_EXTRA_HEADERS_PREFIX@")
  else ()
